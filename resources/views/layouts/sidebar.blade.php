<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            @endif
            @if(Session::get('level') == "penumpang")
            <li class="menu-header small text-uppercase">
              <span class="menu-header-text">Layanan Kami</span>
            </li>
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="pages-account-settings-account.html" class="menu-link">
                    <div data-i18n="Account">Belum Dibayar</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="pages-account-settings-notifications.html" class="menu-link">
            ...
            <li class="menu-sub">
              <a href="" class="menu-link menu-toggle">
                ...
                <div data-i18n="train">Tiket Kereta Api</div>
              </a>
            </li>
            @endif
            ...
            <li class="menu-item">
              ...
              <li class="menu-item">
                  <a href="auth-forgot-password-basic.html" class="menu-link" target="_blank">
                    <div data-i18n="Basic">Tiket Pesawat</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="auth-forgot-password-basic.html" class="menu-link" target="_blank">
                    <div data-i18n="Basic">Tiket Kereta Api</div>
                  </a>
                </li>
              </ul>
            </li>
