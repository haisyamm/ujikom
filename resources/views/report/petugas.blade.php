    ...
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Petugas /</span> List Data</h4>
        ...
        <h2>Laporan Petugas </h2>
                <form method="GET" action="" class="card-header row  py-3 mb-4">
                    ...
                    <div class="col-lg-2">
                    <a target="_blank" href="{{route('report.petugas.pdf', ['from_date' => request()->from_date, 'to_date' => request()->to_date])}}" class="btn btn-secondary btn-round ml-auto">
                        <i class="fa fa-file-pdf"></i>
                        DOWNLOAD PDF
                    </a>
                    </div>
                    <div class="col-lg-2">
                    <a target="_blank" href="{{route('report.petugas.excel', ['from_date' => request()->from_date, 'to_date' => request()->to_date])}}" class="btn btn-default btn-round ">
